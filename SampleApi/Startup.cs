...
namespace SampleApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IClassRoomAppService, ClassRoomAppService>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            var seed = app.ApplicationServices.CreateScope().ServiceProvider.GetRequiredService<SeedData>();
